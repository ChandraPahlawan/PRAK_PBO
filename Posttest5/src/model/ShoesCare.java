...
public final class ShoesCare { // Added final to class
    ...
    private static void tambahPesanan() {
        ...
        switch (jenisProduk) {
            ...
            default: // Tidak akan terjadi karena sudah divalidasi sebelumnya
                return;
        }
    ...
    private static void ubahPesanan() {
        ...
        try {
            ...
            // Perbarui atribut spesifik berdasarkan jenis pesanan
    ...
    // Metode baru untuk menampilkan detail layanan menggunakan metode abstrak
    private static void lihatDetailLayanan() {
        ...
        System.out.println("\n=== Detail Layanan Semua Pesanan ===");
        for (Pesanan p : pesananList) {
            System.out.println("ID: " + p.getId() + ", Nama: " + p.getNamaPelanggan());
            System.out.println("Detail Layanan: " + p.getServiceDetails());
            System.out.println("------------------------------");
        }
    }
}